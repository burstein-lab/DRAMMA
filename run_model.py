...
if __name__ == '__main__':
    ...
    parser.add_argument("-fl", '--filter_low_scores', dest='filter_low_scores', action='store_true', help='Choose this to only keep proteins that passed the minimal model score, default: True (filter_low_scores)')
    parser.add_argument("-kl", '--keep_low_scores', dest='filter_low_scores', action='store_false', help='Choose this to keep results of proteins that received low model scores, default: False (filter_low_scores)')
